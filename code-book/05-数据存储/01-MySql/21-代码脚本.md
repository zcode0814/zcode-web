...
DELIMITER // CREATE FUNCTION rand_string1(n INT) RETURNS VARCHAR(255) #该函数会返回一个字符串
BEGIN
...
DELIMITER // CREATE PROCEDURE insert_s1(IN min_num INT(10), IN max_num INT(10))
BEGIN
